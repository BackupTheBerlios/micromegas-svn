...
class Order
{
  ...
  public:
    ...
    /**
      * Fonction qui lit l'ordre �partir du fichier XML
    ...
    /**
      * Fonction qui renvoie l'ordre qui correspond �l'ideal de l'ensemble donne
    ...
    /**
      * Fonction qui renvoie les predecesseurs immediats d'un ideal donne�dans le treillis des ideaux
      * @param un ensemble d'elements
      */
